          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10">
              ...
              <div>
                ...
                <p className="text-slate-500 text-xs">Cours, quiz, progression</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10">
              <span className="text-xl">👨‍🏫</span>
              <div>
                ...
                <p className="text-slate-500 text-xs">Gestion des cours et évaluations</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10">
              <span className="text-xl">👑</span>
              <div>
                ...
                <p className="text-slate-500 text-xs">Gestion de la plateforme</p>
              </div>
            </div>
          </div>
        </div>
